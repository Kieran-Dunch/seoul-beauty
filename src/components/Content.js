        ...
        <Carousel.Item>
          <div className="d-flex carousel-items body-text">
            ...
            <Col>
              ...
              <p className="h4 my-3 p-5 lh-lg">
                From gentle cleansers to
                potent serums, each product we offer is thoughtfully chosen to
                bring the best of Korean skincare rituals to your daily routine.
                Seoul Beauty is more than just a skincare destination; it's a
                guiding light on your journey to radiant, healthy skin. Join us
                in discovering the beauty secrets that have captivated Korea and
                let Seoul Beauty be your trusted companion in the pursuit of
                skincare simplicity and excellence.
              </p>
            </Col>
          </div>
        </Carousel.Item>
